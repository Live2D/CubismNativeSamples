...
void LAppLive2DManager::OnUpdate() const
{
    ...
    Csm::Rendering::CubismDeviceInfo_Vulkan* deviceInfo = Csm::Rendering::CubismDeviceInfo_Vulkan::GetDeviceInfo(vulkanManager->GetDevice());
...
void LAppLive2DManager::ChangeScene(Csm::csmInt32 index)
{
    ...
    _models[0]->LoadAssets(vulkanManager->GetDevice(), vulkanManager->GetTextureFormat(), modelPath.GetRawString(), modelJsonName.GetRawString());
     ...
     */
    {
        ...
        _models.PushBack(new LAppModel());
        _models[1]->LoadAssets(VulkanManager::GetInstance()->GetDevice(), vulkanManager->GetTextureFormat(), modelPath.GetRawString(), modelJsonName.GetRawString());
