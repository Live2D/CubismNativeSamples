...
namespace LAppDefine {
    ...
    extern const csmInt32 RenderTargetWidth;        ///< デフォルトのレンダーターゲットサイズ 
    extern const csmInt32 RenderTargetHeight;       ///< デフォルトのレンダーターゲットサイズ 

    extern const csmInt32 BackBufferNum;            ///< バックバッファ作成数 
}